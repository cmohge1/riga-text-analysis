...
The `imposters` fucntion is a technique of authorship verification, based on the General Imposters method.
...
In many random iterations it estimates if the text in question was more likely written by the candidate, or by any of the imposters. This requires that the working directory contains two subdirectories: "reference_set" and "test_set."
