...
There are a few functions in R that use regular expressions.

### Flow control: For-loops and conditionals
...
This sets a variable called `name` (any thing you choose to assign) equal to each of the elements of the sequence (which is any sequence of values), which is usually a vector. Each of these iterates over the command as many times as is necessary. 
