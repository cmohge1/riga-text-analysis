...
Instead of just printing out the values held in this new list, you can capture the results into a single matrix using the `rbind` function.
...
barplot(fathers.sons.m, beside=T, col="grey")
```
