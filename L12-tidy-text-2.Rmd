...
alice_words %>%
  ...
  count(word, value, sort = TRUE) %>% # notice here that you're calling on a different observation ("score") instead of the "sentiment" in the previous example: that's due to the tibble structure of the dictionary
