...
Rolling Stylometry technique (which slices an input text into equal-sized samples and compares them sequentially with reference data; it is good at finding local idiosyncrasies in longer texts). This requires that the working directory contains two subdirectories: "reference_set" and "test_set."
